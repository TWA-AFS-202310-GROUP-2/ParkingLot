...
{
    public class ParkingLotTestUserStory4
    {
        [Fact]
        public void Should_park_in_first_parkinglot_when_park_car_given_a_standard_parking_boy()
        {
            //Given
            ...
            //Then
            Assert.Equal(8, lots.ElementAt(0).PositionCapacity());
            Assert.Equal(8, lots.ElementAt(1).PositionCapacity());
        }

        [Fact]
        public void Should_park_in_second_parkinglot_when_first_parkinglot_is_full_given_a_standard_parking_boy()
        {
            //Given
        ...
        [Fact]
        public void Should_get_each_correct_car_when_fetch_twice_given_two_tickets_and_a_standard_parking_boy_with_two_parkinglots()
        {
            //Given
            List<ParkingLots> lots = [new ParkingLots(9), new ParkingLots(8)];
            ParkingBoy parkingBoy = new ParkingBoy(new StandardParkingStrategy(), lots);
        ...
        [InlineData(null)]
        [InlineData("12345")]
        public void Should_throw_err_msg_when_fetch_a_car_given_an_unrecognized_ticket_and_a_standard_parking_boy_with_two_parkinglots(string wrongticket)
        {
            //Given
            List<ParkingLots> lots = [new ParkingLots(9), new ParkingLots(8)];
            ParkingBoy parkingBoy = new ParkingBoy(new StandardParkingStrategy(), lots);
        ...
        [Fact]
        public void Should_throw_err_msg_when_fetch_car_given_used_ticket_and_a_parking_boy_with_two_parkinglots()
        {
            //Given
            List<ParkingLots> lots = [new ParkingLots(9), new ParkingLots(8)];
            ParkingBoy parkingBoy = new ParkingBoy(new StandardParkingStrategy(), lots);
        ...
        [Fact]
        public void Should_throw_err_msg_when_park_car_unavailable_position_and_a_parking_boy_with_two_parkinglots()
        {
            //Given
